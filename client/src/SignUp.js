...
export function SignUp() {
  ...
  return <section>
    <form action="/" method="post" onSubmit={(e) => signup(e, data, setData)}>
      <label>Name</label>
      <input type="text" value={data.name} placeholder="Jon" onChange={(e) => setData({ ...data, name: e.target.value })} />
      <label>Email</label>
      <input type="username" value={data.email} placeholder="jon@doe.com" onChange={(e) => setData({ ...data, email: e.target.value })} />
